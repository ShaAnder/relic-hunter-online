...
// Fixed number added to our internal counter each call
...
const MIX_SHIFT_1 = 15;
const MIX_SHIFT_2 = 7;
const MIX_SHIFT_3 = 14;

// Force a mid-step number to be odd. This is a math trick that keeps the scrambling thorough
const FORCE_ODD_A = 1;
const FORCE_ODD_B = 61;

// Turns the final scrambled whole number into a friendly 0–1 decimal
const UINT32_RANGE = 4294967296;

/**
 * The signature every seeded-random consumer takes. Never call
 * Math.random() directly in gameplay-affecting shared code
 */
